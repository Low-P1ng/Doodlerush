...
const my = {
    ...
    avatar: localStorage.getItem('avatar') || 'https://api.dicebear.com/7.x/avataaars/svg?seed=random&backgroundColor=ffffff',
};
...
function updateAvatar() {
    ...
    const color = bgColor.value.substring(1); // Remove '#' from hex
    const seed = playerName.value || 'random';
    ...
    newAvatar.addEventListener('load', () => {
        const oldAvatar = document.querySelector('#avatar');
